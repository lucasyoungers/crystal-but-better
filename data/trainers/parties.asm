...
FalknerGroup:
	...
	db  7, MURKROW,    POISON_STING, MUD_SLAP, NO_MOVE, NO_MOVE
	db  9, NOCTOWL,    LEER, PECK, HYPNOSIS, MUD_SLAP
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, FURRET,     QUICK_ATTACK, FURY_SWIPES, ATTRACT, NO_MOVE
	db 18, CLEFAIRY,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 19, JIGGLYPUFF, SING, DEFENSE_CURL, POUND, ROLLOUT
...
BugsyGroup:
	...
	db 13, YANMA,      TACKLE, QUICK_ATTACK, DOUBLE_TEAM, NO_MOVE
	db 14, BUTTERFREE, TACKLE, STRING_SHOT, CONFUSION, POISONPOWDER
	db 14, BEEDRILL,   POISON_STING, STRING_SHOT, FURY_ATTACK, NO_MOVE
	db 16, SCYTHER,    QUICK_ATTACK, LEER, PURSUIT, FURY_CUTTER
	db -1 ; end
...
MortyGroup:
	...
	db 21, HAUNTER,    HYPNOSIS, MEAN_LOOK, CURSE, NIGHT_SHADE
	db 23, HAUNTER,    SPITE, SHADOW_BALL, MIMIC, NIGHT_SHADE
	db 23, MISDREAVUS, PSYWAVE, CONFUSE_RAY, MEAN_LOOK, SHADOW_BALL
...
PryceGroup:
	...
	db 32, DELIBIRD,   PRESENT, ICY_WIND, THIEF, BLIZZARD
	db 32, SNEASEL,    ICE_PUNCH, FAINT_ATTACK, SLASH, METAL_CLAW
	db 35, DEWGONG,    HEADBUTT, ICY_WIND, ICE_BEAM, REST
	db 35, CLOYSTER,   SPIKE_CANNON, WITHDRAW, ICY_WIND, CLAMP
	db 38, PILOSWINE,  ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	db 30, SKARMORY,   PECK, SWIFT, AGILITY, STEEL_WING
	db 32, FORRETRESS, PROTECT, SELFDESTRUCT, BIDE, EXPLOSION
	db 32, MAGNETON,   THUNDER_WAVE, LOCK_ON, TRI_ATTACK, ZAP_CANNON
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, LOW_KICK, RAGE, KARATE_CHOP
	db 27, HERACROSS,  HORN_ATTACK, ENDURE, FURY_ATTACK, COUNTER
	db 30, HITMONTOP,  ROLLING_KICK, PURSUIT, QUICK_ATTACK, DETECT
	db 30, MACHAMP,    KARATE_CHOP, SEISMIC_TOSS, FORESIGHT, VITAL_THROW
...
ClairGroup:
	...
	db 35, SEADRA,     SMOKESCREEN, SURF, TWISTER, DRAGONBREATH
	db 35, MANTINE,    BUBBLEBEAM, WING_ATTACK, CONFUSE_RAY, RAIN_DANCE
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, THUNDER, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, BLIZZARD, DRAGONBREATH
	db 37, GYARADOS,   THRASH, TWISTER, HYDRO_PUMP, RAIN_DANCE
	db 40, KINGDRA,    HYDRO_PUMP, ICE_BEAM, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
WillGroup:
	...
	db 40, MR__MIME,    LIGHT_SCREEN, REFLECT, ENCORE, PSYCHIC_M
	db 40, JYNX,       LOVELY_KISS, ICE_PUNCH, BLIZZARD, PSYCHIC_M
	db 41, ESPEON,     SWIFT, PSYCHIC_M, MORNING_SUN, SUNNY_DAY
	db 41, EXEGGUTOR,  SLEEP_POWDER, SOLARBEAM, EGG_BOMB, PSYCHIC_M
	db 41, SLOWKING,   AMNESIA, SWAGGER, PSYCHIC_M, FLAMETHROWER
	db 42, XATU,       NIGHT_SHADE, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 44, RHYDON,     HORN_DRILL, EARTHQUAKE, DYNAMICPUNCH, ROCK_SLIDE
	db 44, STEELIX,    SANDSTORM, CRUNCH, IRON_TAIL, EARTHQUAKE
	db 45, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 45, HITMONTOP,  ROLLING_KICK, PURSUIT, TRIPLE_KICK, DIG
	db 45, HITMONLEE,  HI_JUMP_KICK, MIND_READER, FORESIGHT, MEGA_KICK
	db 46, MACHAMP,    ROCK_SLIDE, EARTHQUAKE, SEISMIC_TOSS, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	DB 46, SNEASEL,    SHADOW_BALL, SLASH, METAL_CLAW, DIG
	db 46, MURKROW,    FAINT_ATTACK, DRILL_PECK, STEEL_WING, ICY_WIND
	db 47, VILEPLUME,  SLEEP_POWDER, SLUDGE_BOMB, MOONLIGHT, PETAL_DANCE
	db 47, UMBREON,    CONFUSE_RAY, FAINT_ATTACK, MOONLIGHT, TOXIC
	DB 47, TYRANITAR,  ROCK_SLIDE, THRASH, SCARY_FACE, CRUNCH
...
KogaGroup:
	...
	db 42, ARIADOS,    TOXIC, SPIDER_WEB, SWAGGER, NIGHT_SHADE
	db 42, VENOMOTH,   SLEEP_POWDER, GIGA_DRAIN, PSYCHIC_M, TOXIC
	db 43, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 43, WEEZING,    SMOKESCREEN, EXPLOSION, SLUDGE_BOMB, FIRE_BLAST
	db 43, FORRETRESS, EXPLOSION, DOUBLE_EDGE, NO_MOVE, NO_MOVE
	db 44, CROBAT,     CONFUSE_RAY, WING_ATTACK, TOXIC, SLUDGE_BOMB
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 49, GYARADOS,   HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM, THUNDER
	db 48, DRAGONITE,  THUNDER_WAVE, DRAGONBREATH, THUNDER, HYPER_BEAM
	db 48, DRAGONITE,  THUNDER_WAVE, DRAGONBREATH, BLIZZARD, HYPER_BEAM
	db 49, AERODACTYL, WING_ATTACK, ANCIENTPOWER, EARTHQUAKE, STEEL_WING
	db 49, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, OUTRAGE
	db 50, DRAGONITE,  FIRE_BLAST, WING_ATTACK, OUTRAGE, HYPER_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 50, GOLEM,      DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 50, ONIX,       BIND, ROCK_SLIDE, EARTHQUAKE, SANDSTORM
	db 50, RHYDON,     SCARY_FACE, HORN_DRILL, EARTHQUAKE, IRON_TAIL
	db 50, OMASTAR,    PROTECT, SPIKE_CANNON, ANCIENTPOWER, HYDRO_PUMP
	db 50, KABUTOPS,   SLASH, ANCIENTPOWER, FURY_CUTTER, SURF
	db 50, MAGCARGO,   AMNESIA, FLAMETHROWER, ROCK_SLIDE, ACID_ARMOR
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 50, QWILFISH,   PIN_MISSILE, TOXIC, RAIN_DANCE, SLUDGE_BOMB
	db 50, LANTURN,    THUNDER_WAVE, CONFUSE_RAY, HYDRO_PUMP, THUNDER
	db 50, STARMIE,    SURF, PSYCHIC_M, RECOVER, ICE_BEAM
	db 50, POLITOED,   PERISH_SONG, HYPNOSIS, RAIN_DANCE, WHIRLPOOL
	db 50, QUAGSIRE,   AMNESIA, EARTHQUAKE, SURF, HEADBUTT
	db 50, OCTILLERY,  OCTAZOOKA, ICE_BEAM, FLAMETHROWER, HYPER_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 50, RAICHU,     THUNDER_WAVE, QUICK_ATTACK, THUNDERBOLT, RAIN_DANCE
	db 50, MAGNETON,   LOCK_ON, TRI_ATTACK, ZAP_CANNON, THUNDER
	db 50, ELECTRODE,  LIGHT_SCREEN, THUNDERBOLT, RAIN_DANCE, EXPLOSION
	db 50, ELECTABUZZ, THUNDERPUNCH, ICE_PUNCH, THUNDER, PSYCHIC_M
	db 50, JOLTEON,    THUNDER_WAVE, AGILITY, THUNDER, BATON_PASS
	db 50, AMPHAROS,   THUNDER, REST, SLEEP_TALK, THUNDERBOLT
	db -1 ; end
...
ErikaGroup:
	...
	db 50, JUMPLUFF,   SYNTHESIS, LEECH_SEED, SLEEP_POWDER, SUNNY_DAY
	db 50, TANGELA,    AMNESIA, GIGA_DRAIN, REST, SLEEP_TALK
	db 50, VICTREEBEL, SWORDS_DANCE, SLUDGE_BOMB, GIGA_DRAIN, SUNNY_DAY
	db 50, BELLOSSOM,  STUN_SPORE, MOONLIGHT, PETAL_DANCE, SOLARBEAM
	db 50, VILEPLUME,  LEECH_SEED, MOONLIGHT, PETAL_DANCE, SOLARBEAM
	db 50, SUNFLORA,   GROWTH, SOLARBEAM, FIRE_BLAST, SYNTHESIS
	db -1 ; end
...
JanineGroup:
	...
	db 50, CROBAT,     THIEF, TOXIC, CONFUSE_RAY, WING_ATTACK
	db 50, WEEZING,    THUNDER, SLUDGE_BOMB, FIRE_BLAST, EXPLOSION
	db 50, ARIADOS,    SPIDER_WEB, AGILITY, BATON_PASS, SLUDGE_BOMB
	db 50, VENOMOTH,   CURSE, SLUDGE_BOMB, HIDDEN_POWER, PSYCHIC_M
	db 50, NIDOQUEEN,  EARTHQUAKE, THUNDER, ICE_BEAM, MOONLIGHT
	db 50, TENTACRUEL, SWORDS_DANCE, SUBSTITUTE, SLUDGE_BOMB, HYDRO_PUMP
	db -1 ; end
...
SabrinaGroup:
	...
	db 50, HYPNO,      THUNDER_WAVE, PSYCHIC_M, LIGHT_SCREEN, REFLECT
	db 50, ALAKAZAM,   RECOVER, THUNDERPUNCH, PSYCHIC_M, DYNAMICPUNCH
	db 50, MR__MIME,   PSYCHIC_M, THUNDER, REFLECT, THIEF
	db 50, ESPEON,     GROWTH, PSYCHIC_M, BITE, MORNING_SUN
	db 50, WOBBUFFET,  COUNTER, MIRROR_COAT, DESTINY_BOND, NO_MOVE
	db 50, GIRAFARIG,  AGILITY, AMNESIA, PSYCHIC_M, THUNDERBOLT
	db -1 ; end
...
BlaineGroup:
	...
	db 50, RAPIDASH,   FIRE_BLAST, DOUBLE_EDGE, HIDDEN_POWER, SUNNY_DAY
	db 50, ARCANINE,   FIRE_BLAST, BODY_SLAM, REST, SLEEP_TALK
	db 50, MAGMAR,     THUNDERPUNCH, FIRE_PUNCH, CROSS_CHOP, HIDDEN_POWER
	db 50, FLAREON,    FIRE_BLAST, SHADOW_BALL, DOUBLE_EDGE, IRON_TAIL
	db 50, MAGCARGO,   CURSE, ROCK_SLIDE, EARTHQUAKE, FLAMETHROWER
	db 50, HOUNDOOM,   FLAMETHROWER, CRUNCH, PURSUIT, ROAR
	db -1 ; end
...
BlueGroup:
	...
	db 60, PIDGEOT,    SWIFT, TOXIC, WING_ATTACK, STEEL_WING
	db 60, ALAKAZAM,   THUNDERPUNCH, RECOVER, PSYCHIC_M, ICE_PUNCH
	db 60, RHYDON,     CURSE, ROAR, ROCK_SLIDE, EARTHQUAKE
	db 60, GYARADOS,   THUNDER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 60, EXEGGUTOR,  SLEEP_POWDER, PSYCHIC_M, GIGA_DRAIN, EXPLOSION
	db 60, ARCANINE,   FLAMETHROWER, BODY_SLAM, REST, SLEEP_TALK
	db -1 ; end
